               ...
               <div class="task_details"> 
                ...
                <div class="task_notes_wrap">
                    <div class="task_notes_header">
                        <h3>Task Notes</h3> <button class='btn-small task_note_acton'><i class='fa fa-plus'></i></button>
                    ...
                    <div class="task_notes_body"><!-- task notes body -->
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<li class='task_note'><div class='task_note_text'>" . nl2br($comment) . "</div><div class='task_note_action'><button class='btn-small btn_remove_task_note'><i class='fa fa-times'></i></button></div></li>";
                            //echo nl2br($comment);
                        }                             
                        echo "</ul>";
                        }
