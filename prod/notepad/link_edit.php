   ...
   if (isset($_POST['edit_link']))
{
    ...
    $sql="UPDATE tblcustomer_notes set cust_id=$customer,title='$note_title', note_source='$note_source' where id=$note_id";
         ...
         ?>
            <form action="" method="post" id="edit_note_form">
               ...
               <div class="edit_note_action">
                     <a href='index.php' class="flat-btn">&lt;&lt; Back to home</a> <button name="edit_link" type="submit" class="flat-btn">Save changes</button>
               </div>
