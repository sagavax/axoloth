     ...
     <div class="password">    
      ...
      <input type="hidden" name="id" value="<?php echo $row['PassID']; ?>" />
        ...
        <table>
          ...
          <tr>
           <td><div class="embed-button"><input type="text" name="password" id="password" value="<?php echo $row['password']?>"><button onClick="populateform(15)" class="flat-btn" type="button"  id="generuj_pass"><i class="fas fa-sync-alt"></i></button></div></td>
