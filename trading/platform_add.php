...
$platform_logo = mysqli_real_escape_string($con, $_POST['logo']);
...
$add_platform="INSERT INTO tbltrading_platforms (platform_name, platform_logo, added_date)VALUES ('$platform_name','$platform_logo','$curr_date')"; 
echo $add_platform;
