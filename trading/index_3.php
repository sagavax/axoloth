...
?>
    ...
    <div id="layout">
        ...
        <div class="trading_info_wrap">
           <div id="tabs">
                <ul>
                    <li class="tab_active" tab-data="platforms">Platforms<button id="modal_add_platform" class="btn-small"><i class="fa fa-plus"></i></button></li>
                    <li class="tab_inactive" tab-data="assets">Asset<button id="modal_add_asset" class="btn-small"><i class="fa fa-plus"></i></li>
                    <li class="tab_inactive" tab-data="notes">Notes<button id="modal_add_note" class="btn-small"><i class="fa fa-plus"></i></li></li>
                </ul>
            </div>
...
?>
            ...
            <div class="trading_assets"></div>
            <div class="trading_notes"></div>
        </div>
    </div>
