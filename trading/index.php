    ...
    <div id="layout">
        <div class=" fab-container">
            ...
            <ul class="fab-options">
                ...
                <li>
                    <span class="fab-label">New asset</span>
                    <div class="fab-icon-holder">
                         <i class="fa fa-plus"></i></a>
                    </div>
                </li>
        ...
        <div class="trading_info_wrap">
            <div class="trading_wrap">
                <div id="tabs">
                            <div class="tab_active" tab-data="platforms">Platforms<button id="modal_add_platform" class="btn-small" type="button"><i class="fa fa-plus"></i></button></div>
                            <div class="tab_inactive" tab-data="assets">Asset<button id="modal_add_asset" class="btn-small" type="button"><i class="fa fa-plus"></i></div>
                            <div class="tab_inactive" tab-data="notes">Notes<button id="modal_add_note" class="btn-small" type="button"><i class="fa fa-plus"></i></div>
...
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<div class='platform' id=$id platform-url=$platform_url>";
	...
	echo "<div class='trading_feeds' platform-id=$id platform-name=$platform_name>";
	$get_platf_notes = "SELECT * from tbltrading_platform_notes where platform_id=$id ORDER BY note_id DESC";
...
?>
                    ...
                    <div class="trading_notes">
                        <div class="search_wrap">
                            ...
                            <div class="notes">
                            <?php
$get_assets = "SELECT * from tbltrading_platform_notes ORDER BY note_id DESC";
$result = mysqli_query($con, $get_assets) or die("MySQL ERROR: " . mysqli_error($con));
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<div class='note'>";
	echo "<div class='note_text'>$note_text</div>";
	echo "<div class='note_action'><button type='button' class='btn-small remove_note'><i class='fa fa-times'></i></button><button type='button' class='btn-small edit_note'><i class='fa fa-edit'></i></button></div>";
	echo "</div>";
}
?>
                            </div>
    ...
    <div class="new_trading_platform">
        ...
        <input type="text" placeholder="Logo" id="platform_logo" autocomplete="off">
        <div class="action_wrap">
    ...
    <div class="trading_note">
        <input type="text" placeholder="note title.." id="trading_note_title" autocomplete="off">
            <textarea id="trading_note_text" placeholder="type something ..."></textarea>
            <div class="action_wrap">
                <button type="button" class="flat-btn" id="hide_trading_note"><i class="fa fa-times"></i></button>
                <button type="button" class="flat-btn" id="add_trading_note"><i class="fa fa-plus"></i> Add</button>
          </div>
    </div>

    <div class="edit_platform_note">
        <input type="text" placeholder="note title.." id="note_title" autocomplete="off">
            <textarea id="edit_note_text" placeholder="type something ..."></textarea>
            <div class="action_wrap">
                <button type="button" class="flat-btn" id="hide_update_note"><i class="fa fa-times"></i></button>
                <button type="button" class="flat-btn" id="update_note"><i class="fa fa-edit"></i> Update</button>
          </div>
    </div>
...
?>
        ...
        <div class="action_wrap">
            ...
            <button type="button" class="flat-btn" id="assign_asset"><i class="fa fa-plus"></i> Add</button>
        </div>
    </div>
