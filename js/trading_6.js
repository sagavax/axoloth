...
for (var i = 0; i < parents.length; i++) { //divs with class trading_feeds
    ...
    parents[i].addEventListener("click", function(e) {
        ...
        if (e.target.classList.contains("note_delete") === true) {
            alert("delete note");
            //var note_id = this.childNode.getAttribute("note-id");
            //console.log(e.target.classList.contains("btn-small note_delete"));
            console.log(e.target.parentNode.parentNode.getAttribute("note-id"));
            //delete_platform_note(note_id);
        }

        if (e.target.classList.contains("fa-times") === true) {
            alert("delete note");
            //var note_id = this.childNode.getAttribute("note-id");
            //console.log(e.target.classList.contains("btn-small note_delete"));
            console.log(e.target.parentNode.parentNode.getAttribute("note-id"));
        ...
        if (e.target.classList.contains("note_edit") === true) {
            alert("edit note");
