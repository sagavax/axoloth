    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("pass_note_text").value = "";
             attach_new_pass_note(note_text,id);
        }
    };
...
function attach_new_pass_note(note_text,note_id) {
    ...
    parent_container.insertAdjacentHTML('afterbegin', "<div class='pass_note'><button class='close' type='button'><i class='fa fa-times'></i></button>" + note_text + "</div>");
