...
if (mysqli_num_rows($result) == 0) {
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		*/
		...
		echo "</div></td>";
		echo "<td><ul id='pass_actions'><li><a href='password${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-eye'></i></a></li><li><a href='password_edit${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-edit'></i></a></li><li><a href='password_delete${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-times'></i></a></li><li><a href='password_archive${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-archive'></i></a></li></ul></td>";
		echo "</tr>";
	}
}
?>
