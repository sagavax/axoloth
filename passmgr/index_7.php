...
if (mysqli_num_rows($result) == 0) {
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		*/
		...
		echo "</div></td>";
		echo "<td><ul id='pass_actions'><li><a href='#' class='btn-small' onclick='show_pass_details($id)'>View</a></li><li><a href='password_edit${page_ext_qry}id=$id' class='btn-small'>Edit</a></li><li><a href='password_delete${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-times'></i></a></li><li><a href='password_archive${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-archive'></i></a></li></ul></td>";
		echo "</tr>";
	}
}
?>
...
$result = mysqli_query($con, $sql) or die("MySQL ERROR: " . mysqli_error($con));
while ($row = mysqli_fetch_array($result)) {
	echo "<li><a href='#' onclick='show_pass_details(" . $row['PassID'] . ")'class='link'>" . $row['system_name'] . "</a></li>";
}
?>
            </div>
