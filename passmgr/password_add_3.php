...
?>
               ...
               <tr>
                  <td><input type="text" name="system_name" autocomplete="off" placeholder="System name" value=""></td>
               </tr>
               <tr>
                    <td><input type="text" autocomplete="off" name="user_name" placeholder="User name" value=""></td>
               </tr>
               <tr>
                  <td><div class="embed-button"><input type="text" name="password" id="password" placeholder="Password" value=""><button onclick="generate_password()" class="flat-btn" type="button"  id="generuj_pass"><i class="fas fa-sync-alt"></i></button></div></td>
               </tr>
               <tr>
