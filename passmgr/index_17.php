        ...
        <div id="passwords_wrap">
         <div class=" fab-container">
              ...
              <!--letter list -->
                ...
                <div id="pass_tabs"><ul><li class="tab">All</li><li class="tab">Favorites</li><li class="tab">Most popular</li><li class="tab">Newest</li></ul></div>
                <div id="pass_tabs_1">
                	<button class="taby" type="button">All</button>
                	<button class="taby" type="button">Favorites</button>
                	<button class="taby" type="button">Most popular</button>
                	<button class="taby" type="button">Newest</button>
                </div>
...
if (mysqli_num_rows($result) == 0) {
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		*/
		...
		echo "</div></td>";
		echo "<td><div class='pass_actions_wrap'><ul class='pass_actions'><li><a href='password${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-eye'></i></a></li><li><a href='#' title='Add note' onclick='show_add_note($id)'; class='btn-small'><i class='fas fa-plus'></i></a></li><li><a href='password_edit${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-edit'></i></a></li><li><a href='password_archive${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-archive'></i></a></li><li><a href='password_clone${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-copy'></i></a></li><li><a href='password_delete${page_ext_qry}id=$id' class='btn-small remove'><i class='fas fa-times'></i></a></li><li><div class='mobile_actions'><button class='btn-small mobile_menu' type='button'><i class='fa fa-angle-down'></i></button><div class='menu'>";

		echo getMobileMenu();

		echo "</div></div></li></ul></div></td>";
		echo "</tr>";
