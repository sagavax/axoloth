...
<?php if (isset($_POST['save_changes'])) {
	...
	$sql = "UPDATE tblcustomer_events SET cust_id=$cust_id, event_title='$event_title',event_description='$event_description', start_event_date='$start_event_date',end_event_date='$end_event_date',start_event_time='$start_event_time',end_event_time='$end_event_time',event_date='$event_date',is_meeting=$is_meeting WHERE event_id=$event_id";
...
$row = mysqli_fetch_array($result);{
	...
	?>
                              ...
                              <td>Meeting:</td><td><input type="checkbox" name="is_meeting" value="<?php echo $is_meeting; ?>"></td>
                            </tr>
                            <tr>
       ...
       <script>
        ...
        /* function update_event_color(color, event_id){
          ...
          xhttp.onreadystatechange = function() {
           ...
           alert("event color changed");// document.getElementById("demo").innerHTML = this.responseText;
          }
          data = "event_id="+event_id+"color=" + encodeURIComponent(color);
          xhttp.open("GET", "event_color.php?event_id="+event_id+"color=" + encodeURIComponent(color), true);
          //xhttp.open("POST", "event_color.php", true);
          //xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
          //xhttp.send("event_id="+event_id+"color=" + encodeURIComponent(color));
          xhttp.send();
        }
         }*/
       </script>
