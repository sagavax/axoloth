                    ...
                    <div id="edit_event_wrap">
                        ...
                        <input type="hidden" name="event_id" value="<?php echo $event_id ?>">
                          <table id="edit_event">
                            ...
                            <tr>
                              <td>Event time (end):</td><td><input type="text" name="event_color" value="<?php echo $row['event_color']; ?>"></td>
                            </tr> 
                            <tr>
                              <td colspan="2"><button name="save_changes" class="flat-btn">Save</button></td>
                            </tr>
                          </table>
                          </form>  
                      </div> 
