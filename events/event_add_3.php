...
?>
                      ...
                      <tr>
                        <td>Event date (start):</td><td><input type="date"  onchange="date_validation();" name="start_event_date" id="start_date" value="<?php
...
?>">
                 ...
                 <script scr="../js/event_date_valid.js"></script>
                 <script>
