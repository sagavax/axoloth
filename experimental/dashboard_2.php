...
<body ng-app="myApp" ng-controller="MainCtrl">
	...
	<div id="layout">
		<div id="new_session">
			WELCOME TO THE INFORMATING SYSTEM <?php echo date('j.n.Y')?>&nbsp;<span class="location_city">{{city}}</span> <span class="temp">{{temp}} &#176;</span>&nbsp;<span class="icon"><i ng-class="getIcon()"></i></span>&nbsp;&nbsp;<span id="curr_time"></span>
