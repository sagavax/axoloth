<?php
	...
	$sql="INSERT INTO tblcustomer_notes_history (action, app, text_logu, date_added, is_read) VALUES ('$curr_action','$curr_app','$text_logu','$curr_date',0)";
	 ...
	 $sql="INSERT INTO diary (diary_text, date_added,location,is_mobile) VALUES ('$diary_text','$curr_date','',0)";
	 $result = mysqli_query($link1, $sql) or die("MySQLi ERROR: ".mysqli_error($connection));
	 mysqli_close($link1);
