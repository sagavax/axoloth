<?php
  ...
  if($status<>""){
    $sql="SELECT * from tblcustomer_tasks WHERE task_status ='$status'";
  } else {
    $sql="SELECT * from tblcustomer_tasks WHERE task_status<>'complete'";
  }
   // $sql="SELECT * from tblcustomer_tasks WHERE task_priority='$priority' and task_status<>'complete'";
