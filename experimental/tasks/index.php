        ...
        <div class="tasks_wrap">
            ...
            if ($num == 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<form action='' method='post'><input type='hidden' name=task_id value=$id>";
                        echo "<ul>";
