...
if (isset($_POST['update_task'])) { //update task
  //var_dump($_POST);
  ...
  if (isset($_POST['mark_as_complete'])) { //dal som checkbox,ze task je coompleted
            ...
            <table class="task_details">
              ...
              <tr>
                ...
                <td>
                  ...
                  <label id="percent_done_1"></label>
                  <input type="text"  class="yesno-input"  id="percent_done" value="<?php echo $percent_done; ?>"/>
              ...
              <tr>
                <td colspan="2" style="text-align:center"><input type="checkbox" name="mark_as_complete" title="mark as complete" id="mark_as_complete"><label for="mark_as_complete">Complete</label> </td>
              <tr>
                <td colspan="2" style="text-align:right"><button name="update_task" class="flat-btn">Update task</button>
            </table>
          </form>
        </div>
        <div class="task_preview_footer"></div>
      </div> <!-- edit task wrap -->
      <div><a href="index.php" class="action_link">&lt;&lt; Back</a></div>
    </div>
    <!-- end of layout -- >  
