                ...
                ?>
                  ...
                  <form action="" method="post">
                    ...
                    <table>
                      ...
                      <tr>
                        <td>Title:</td><td><input type="text" name="event_title"></td>
                      </tr>
                      ...
                      <tr>
                        <td>Event date (end):</td><td><input type="date" id="end_date" name="end_event_date" value=
                      ...
                      <tr>
                        <td>Event date:</td><td><input type="text" name="event_date" id="event_date" value="<?php
                      ...
                      <tr>
                        <td colspan="2"><button name="add_event" class="flat-btn">New event</button></td>
                      </tr>
                    </table>
                  </form>    
