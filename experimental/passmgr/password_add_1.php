      ...
      <div id="password_view_wrap">
          <form accept-charset="utf-8" method="post" action="" name="new_password">
            <table class="password">
               ...
               <tr>
                  <td><div class="embed-button"><input type="text" name="password" id="password" placeholder="Password" value=""><button onClick="populateform(15)" class="flat-btn" type="button"  id="generuj_pass"><i class="fa fa-refresh"></i></button></div></td>
               </tr>
               <tr>
               ...
               <tr>
                  <td colspan="2" style="text-align:right"><button type="submit" name="new_password" class="flat-btn">New password</button></td>
               </tr>
            </table>
         </form>
