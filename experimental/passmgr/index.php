        ...
        <div id="passwords_wrap">
            <div id="left_panel">
                <div id="letter_list">
                    ...
                    echo "<li><form action='' method='post'><button type='submit' name='add_new_pass' class='flat-btn' id='add_new_pass' title='Add new password'><i class='fa fa-plus'></i></button></form></li>";
                    echo "</ul>";
                    ?>
                </div>
                <!--letter list -->
                ...
                <table id="pass_maintable">
                    ...
                    <tr>
                        ...
                        <th class="pass_group">Customer</th>
                    ...
                    if (mysqli_num_rows($result) == 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            /*  if($url<>'') {//url je zadane
                                        ...
                                        */
                            echo "<td scope='row' data-label='System name' class='pass_system_name hasTooltip' data-href='$url'><b>$system_name</b></td>";
                            echo "<td  data-label='User name'>$user_name</td><td data-label='Customer'>$customer_name</td>";
                            echo "<td  data-label='Favorite'><div id='fav-$id' class='fav_id'>";
                            if ($is_favorite == 1) {
                            ...
                            echo "</div></td>";
                            echo "<td style='width:215px' data-label='Actions'><ul id='pass_actions'><li><a href='#' class='btn-small' onclick='show_pass_details($id)'>View</a></li><li><a href='password_edit${page_ext_qry}id=$id' class='btn-small'>Edit</a></li><li><a href='password_delete${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-times'></i></a></li><li><a href='password_archive${page_ext_qry}id=$id' class='btn-small'><i class='fas fa-archive'></i></a></li></ul></td>";
                            echo "</tr>";
                        }
                    }
                    ?>
