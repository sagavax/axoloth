...
<div class=" fab-container">
        <div class="fab-icon fab-icon-holder">
            <i class="fas fa-plus"></i>
        </div>
        <ul class="fab-options">
           <li>
                <span class="fab-label">New note</span>
                <!--<div class="fab-icon-holder" onclick="add_new_note();"> -->
            ...
            <li>
                <span class="fab-label">New tweet</span>
                <div class="fab-icon-holder">
                    <a href="note_add_tweet.php"><i class="fab fa-twitter"></i></a>
                </div>
            </li>
            <li>
                <span class="fab-label">New instagram tweet</span>
                <div class="fab-icon-holder">
                    <a href="note_add_instagram.php"><i class="fab fa-instagram"></i></a>
                </div>
            </li>
            <li>
                <span class="fab-label">New fb tweet</span>
                <div class="fab-icon-holder">
                    <a href="note_add_instagram.php"><i class="fab fa-facebook-f"></i></a>
                </div>
            </li>
        </ul>
        </div><!-- fab container -->
            ...
            <div class="middle_wrap">
                ...
                /*       <iframe id="ytplayer" type="text/html" width="<?php echo $width ?>" height="<?php echo $height ?>"
                      ...
                      frameborder="0" allowfullscreen></iframe> */
                                ...
                                if ($note_type == 'tweet'){
                                    echo "<div class='note_tweet'>";
                                        echo html_entity_decode($note);
                                    echo "</div>";
                                }  
                                
                                if ($note_type == 'instagram'){
                                    echo "<div class='note_tweet'>";
                                        echo htmlspecialchars_decode($note);
                                    echo "</div>";
                                }  

                                if ($note_type == 'facebook'){
                                    echo "<div class='note_facebook'>";
                                        echo htmlspecialchars_decode($note);
                                    echo "</div>";
                                } 
