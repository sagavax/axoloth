...
if (isset($_POST['edit_link'])) {
   ...
   $sql = "UPDATE tblcustomer_notes set cust_id=$customer,title='$note_title', note_source='$note_source',note_type='image' where id=$note_id";
   //echo $sql;
         ...
         ?>
            <form action="" method="post" id="edit_note_form">
               ...
               <div class="edit_note_action">
                  <button name="edit_image" type="submit" class="flat-btn">Save changes</button>
               </div>
