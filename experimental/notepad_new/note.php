               ...
               echo "<div class='note_wrap'>";
                ...
                elseif($note_type="ext_image") {
                   echo "<div class='note_image'><img src='".$row['note_source']."'></div>";
                           ...
                           echo "<div class='note_view_action'><a href='note_edit.php?note_id=$note_id' class='flat-btn-small'>Edit</a> <a href='note_delete.php?note_id=$note_id' class='flat-btn-small'>Delete</a> <a href='note_clone.php?note_id=$note_id' class='flat-btn-small'>Clone</a></div>";
