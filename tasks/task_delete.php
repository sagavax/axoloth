<?php
	...
	$sql="UPDATE tblcustomer_tasks set task_status='cancelled' WHERE id='$task_id'";
    ...
    $curr_action="cancel_task";
    $curr_app="task_manager";
    //$new_note_id=GetLatestNote();
    $text_logu="The task id $task_id has been cancelled";
	...
	$link1 = mysqli_connect(null, "brick_wall", "h3jSXv3gLf", "brick_wall", null, "/tmp/mariadb55.sock");
	 ...
	 $diary_text="EIS: Task s id $task_id bol zruseny";
	 $sql = "INSERT INTO diary (diary_text, date_added,location,isMobile) VALUES ('$diary_text','$curr_date','',0)";
	 $result = mysqli_query($link1, $sql) or die("MySQLi ERROR: ".mysqli_error($link1));
	 mysqli_close($link1);
	
	   echo "<script>alert('The task id $task_id has been cancelled successfully');
