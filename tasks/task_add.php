...
if (isset($_POST['add_task'])) {
	...
	if ($task_category == 5) {
		//task sa tyka minecraftu tak presunie do ineho informcneho systemu
...
if (isset($_GET['cust_id'])) // task pridavam z externej stranky
{
	...
	//task je uplne novy a je vytvarany z modulu tasks
...
?>
					        ...
					        <tr>
					           <td style="text-align:right"><a href="index.php?display_as=list" class="flat-btn">&lt;&lt; Back</a> <button name="add_task" class="flat-btn">Add new</button></td>
					        </tr>
					    </table>
					</form>
