  ...
  if (isset($_POST['update_customer']))
    {
        ...
        echo "<script>localStorage.setItem('cust_id',$cust_id);</script>";
        $customer_status=mysqli_real_escape_string($con, $_POST['customer_status']);
        if($cust_id==0 && $customer_status == "inactive") {// to som ja 
          echo "<script>alert('Cannot deactivate myself');
              cust_id = localStorage.getItem('cust_id');
              window.location.href='customer_update.php?cust_id='+cust_id;
          </script>";
        } else {
        ...
        echo "<script>alert('the customer with id $cust_id has been updated');
      ...
      <div class="customer_info">  
        ...
        <form accept-charset="utf-8" method="post" action="">
          ...
          <table>
            ...
            <tr>
              <td colspan="2" style="text-align:right"><div class="update_customer_info"><a href='index.php' class="flat-btn">&lt;&lt; Back</a> <button type="submit" name="update_customer" class="flat-btn">Update</button></div></td>
            </tr>
          </table>
        </form>
      </div><!-- customer_info -->
