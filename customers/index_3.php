...
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<td style='width:45%'><a href='customer.php?cust_id=$cust_id' class='customer_name'>$customer_name</a></td><td><ul id='customers_actions'><li><a href='customer_update.php?cust_id=$cust_id' class='btn-small'>Edit</a></li><li>";
...
?>
              <tr><td colspan="2">
                    ...
                    <input type="text"id="customer_name" name="customer_name" autocomplete="off" placeholder="Customer name..."/>
     ...
     <Script type="text/javascript" scr="../js/customers.js"></script>
</body>
</html>
