      ...
      <form action="" method="post" id="new_note_form">
         <div class="edit_note_wrap">
            ...
            <div class="edit_note_action">
               <button type="button"class="flat-btn" onclick="window.location.href='index.php'"><< Back</button>
               <button name="add_ext_pic" id="add_ext_pic" type="submit" class="flat-btn">Add picture</button>
            </div>
         </div>
      </form>
   </div>
