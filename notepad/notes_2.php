...
} else if(isset($_GET['tab_id'])){
    $tab_id=$_GET[tab_id];
    if($tab_id = "Notes"){
        $sql = "SELECT a.id, a.cust_id, a.title, a.note, a.date_created,a.note_source, b.cust_id, b.customer_name,a.cat_id,a.note_type from tblcustomer_notes a, tblcustomers b WHERE a.note_type='note' and a.cust_id=b.cust_id ORDER BY a.id DESC";  
    } else if($tab_id = "Videos"){
        $sql = "SELECT a.id, a.cust_id, a.title, a.note, a.date_created,a.note_source, b.cust_id, b.customer_name,a.cat_id,a.note_type from tblcustomer_notes a, tblcustomers b WHERE a.note_type='video' and a.cust_id=b.cust_id ORDER BY a.id DESC"; 
    }
}  
//echo $sql;
//$sql = "SELECT a.id, a.cust_id, a.title, a.note, a.date_created,a.note_source, b.cust_id, b.customer_name,a.cat_id,a.note_type from tblcustomer_notes a, tblcustomers b WHERE a.cust_id=b.cust_id ORDER BY a.id DESC";
