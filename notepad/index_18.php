...
*/
		...
		foreach ($cat_ids as $cat_id) {
			//print_r($cat_ids);
			$cat_name = GetCatName($cat_id);
			$cat_list .= "<button cat-id=$cat_id class='btn-small'>$cat_name</button>";
		}
		$cat_list .= "</div>";
		...
		echo "<button title='Add new category' class='btn-small-hollow' note-id=$note_id onclick='ShowModalAddCat($note_id)';><i class='fa fa-plus'></i></button>";
		echo $cat_list;
		echo "<button class='btn-small-green'>$customer_name</button>";
...
?>
           ...
           <div id="add_new_link" class="overlay">
            ...
            <div id="add_new_short_note" class="overlay">
            <div>
                    <input type="text" id="short_note_title" autocomplete="off" placeholder="title">
                    <textarea id="short_note_text" placeholder="type some text here...."></textarea>
                    <section>
            ...
            <div id="modal_add_new_note" class="overlay">
                <div>
                    <input type="text" id="normal_note_title" autocomplete="off" placeholder="title">
                    <textarea name="normal_note_text" id="normal_note_text" placeholder="type some text here...."></textarea>
                    <script type="text/javascript">
                          window.onload = function() {
                           // CKEDITOR.replace("normal_note_text');
                            };
                        </script>
                    <section>
                        <button type="button"class="flat-btn" onclick="hide_add_note()"><i class="fa fa-times"></i></button>
                        <button id="btnAddNote" type="button" class="flat-btn">Add note</button>
                    </section>
                </div>
            </div>
        ...
        <script src="../js/notepad_short_note.js"></script>
        <script src="../js/notepad_normal_note.js"></script>
