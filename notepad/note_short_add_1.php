...
<head>
   <meta charset="utf-8" />
   <title>axoloth - Add new note</title>
         ...
         <div class="add_new_note_wrap">
             <form action="" method="post" id="new_note_form">
                  <table id="new_note">
                     ...
                     <tr>
                     <td class="add_note_action"><a href='index.php' class="flat-btn">&lt;&lt; Back to home</a> <button name="add_short_note" type="submit" class="flat-btn">Add note</button></td>
                     </tr>
                  </table>
               </form>
           </div>
